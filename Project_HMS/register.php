...
<body>
    <div class="container">
       ...
       <h3 align="center" text-color="red">Doctor's Registration</h3>
    <form id="form" class="form"  action="regval.php" method="post" autocomplete="" onsubmit="return validated()">
...
<input type="Password" name="cpass" id="cpass" placeholder="Re-type your password" > <br> <br>
</div>	
...
<button class="deleteBtn"><a href="login.php">Aleady have account</a></button>
