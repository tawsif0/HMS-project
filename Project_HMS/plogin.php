...
<body>
    <div class="container">
       ...
       <h2 align="center">Patient's Login</h2>
    <form name="form" id="form" action="ploginval.php" method="post" autocomplete="" onsubmit="return validated()">
...
<button class="deleteBtn"><a href="preg.php">Register as a patient</a></button>
